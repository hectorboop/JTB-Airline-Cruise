<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CruiseList.aspx.cs" Inherits="JTB_Airline_Cruise.CruiseList" %>
						...
						<div class="text-white ">
							<h2 class="fs-50">
								<span class="font-weight-bold">
									<asp:Label ID="CruiseCountLabel" runat="server" Text="Label"></asp:Label>
							    </span>  Cruises available
							</h2>
						</div>
						<div class="dark-checkboxes text-white d-flex">
							<div class="custom-controls-stacked d-sm-flex ">
								<label class="custom-control custom-radio ms-4">
									...
									<span class="custom-control-label">River Cruise</span>
								</label>
								<label class="custom-control custom-radio ms-4">
									<input type="radio" class="custom-control-input" name="example-radios" value="option2">
									<span class="custom-control-label">Ocean Cruise</span>
								</label>
							</div>
							<div class="dropdown ms-5 ps-4 mt-1">
								<a href="javascript:void(0)" class="text-white mt-2 py-1 px-3 br-2" data-bs-toggle="dropdown" aria-expanded="false"><span> Interior <i class="fa fa-caret-down text-white ms-2"></i></span> </a>
						...
						<div class="search-background mt-4">
							<div class="form row g-0">
								<div class="form-group  col-xl-2 col-lg-2 col-md-12 mb-0">
									<input type="text" class="form-control location-input border-end br-te-0 br-be-0 input-lg" placeholder="Find Cruises" disabled="disabled">
	...
	<div class="bg-white border-bottom">
		<div class="container">
			<div class="page-header">
				<h4 class="page-title">Cruise List</h4>
				<ol class="breadcrumb">
					<li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
					<li class="breadcrumb-item active" aria-current="page">Cruise List</li>
				</ol>
			</div>
		</div>
	</div>
				...
				<div class="col-xl-3 col-lg-3 col-md-5">
					<div class="card mb-lg-0">
						...
						<div class="card-body pb-0">
							<h5 class="font-weight-semibold2 mb-3">Room Type</h5>
							<div class="">
								<div class="filter-product-checkboxs">
									<label class="custom-control custom-checkbox mb-3">
										<input type="checkbox" class="custom-control-input" name="checkbox1" value="option1">
										<span class="custom-control-label">
											<a class="text-dark">Interior
												<span class="label label-light float-end">
													<asp:Label ID="InteriorLabel" runat="server" Text="Label"></asp:Label>
											    </span>
											</a>
										</span>
									</label>
									<label class="custom-control custom-checkbox mb-3">
										...
										<span class="custom-control-label">
											<a class="text-dark">Ocean View
												<span class="label label-light float-end">
													<asp:Label ID="OceanViewLabel" runat="server" Text="Label"></asp:Label>
												</span>
											</a>
										</span>
									</label>
									<label class="custom-control custom-checkbox mb-3">
										...
										<span class="custom-control-label">
											<a class="text-dark">Balcony
												<span class="label label-light float-end">
													<asp:Label ID="BalconyLabel" runat="server" Text="Label"></asp:Label>
												</span>
											</a>
										</span>
									</label>
									<label class="custom-control custom-checkbox mb-3">
										...
										<span class="custom-control-label">
											<a class="text-dark">Suite
												<span class="label label-light float-end">
													<asp:Label ID="SuiteLabel" runat="server" Text="Label"></asp:Label>
												</span>
											</a>
										</span>
									</label>
						...
						<div class="card-body pb-0 border-top-0 pb-7">
							<h5 class="font-weight-semibold2 mb-4">Cruise Lines</h5>
							<div class="" id="container">
								<div class="filter-product-checkboxs">
									<!-- Add Repeater -->
									<asp:Repeater ID="CruiselineRepeater" runat="server">
										<ItemTemplate>
											<label class="custom-control custom-checkbox mb-3">
												<input type="checkbox" class="custom-control-input" name="checkbox1" value="option1">
												<span class="custom-control-label">
													<a class="text-dark"><%# Eval("Name") %><span class="label label-light float-end"><%# Eval("CruiseCount") %></span></a>
												</span>
											</label>
										</ItemTemplate>
									</asp:Repeater>
															...
															<div class="d-xl-flex ieh-100">
																<div class="item-card9-img w-100">
																	<div class="item-card9-imgs">
																		<img src="/Assets/images/categories/cruises/cruise.jpg" alt="img" class="cover-image">
																	...
																	<div class="card-body">
																				...
																				<div class="">
																					<i class="text-dark">
																						<h4 class="font-weight-semibold2 mt-1 mb-2 leading-normal">
																							<%# Eval("Cruiseline") %> Cruise-
																							<asp:Label ID="Id" runat="server" Text='<%# Eval("Id") %>'></asp:Label>
																						</h4>
																					</i>
																					<asp:Repeater ID="RoomTypeRepeater" runat="server" DataSource='<%# Eval("RoomTypes") %>'>
																						<ItemTemplate>
																		...
																		<div class="item-card2-desc">
																			<a href="javascript:void(0)" class="mt-1 mb-0 text-dark d-block">
																				<i class="fe fe-calendar me-1 d-inline-block"></i> <%# Eval("StartDate") %> - <%# Eval("EndDate") %></a>
																			<a href="javascript:void(0)" class="mt-2 mb-0 text-dark d-block">
																				<i class="fe fe-map-pin me-1 d-inline-block"></i> <%# Eval("DeparturePort") %> - <%# Eval("VisitingPorts[0]") %> </a>
																		</div>
																	</div>
																	<div class="card-footer d-flex">
																		<div class=" d-inline-flex">
																			<a class="fs-13 leading-tight mt-1" href="javascript:void(0)"><%# Eval("Ship") %></a>
																		</div>
																		<div class="ms-auto">
																			<h3 class="mb-0 font-weight-semibold2">
																				<asp:LinkButton ID="SubmitLinkButton" CssClass="btn btn-primary" OnClick="SubmitLinkButton_Click" runat="server">From $<%# Eval("CruisePrice[0]") %>*</asp:LinkButton>
																			</h3>
																		</div>
																	</div>
																</div>
