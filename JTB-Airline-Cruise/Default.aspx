...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
	...
	<section class="sptb">
		<div class="container">
			<div class="section-title center-block text-center">
				<span class="heading-style text-secondary">Best Offer</span>
				<h2>Travel Packages</h2>
				<p>Travelling is a adventure..So exeprience the adventure</p>
			</div>
			<div id="myCarousel2" class="owl-carousel owl-carousel-icons">
					...
					<div class="card mb-0 overflow-hidden">
						...
						<div class="item-card7-imgs">
							...
							<div class="item-card7-overlaytext">
								<h4 class="mb-0">$40 <del class="text-white-80 fs-14">$50</del></h4>
							</div>
						</div>
						<div class="card-body">
							<div class="border-bottom pb-4 mb-4 d-inline-flex">
								<span class="border-end pe-3 me-3"><i class="icon icon-clock me-1"></i> 12 Days</span>
								<span class="border-end pe-3 me-3"><i class="icon icon-location-pin me-1"></i> London</span>
								<span class=""><i class="icon icon-event me-1"></i> 9th Nov</span>
							</div>
							<div class="item-card7-desc">
								<div class="item-card7-text d-flex">
									<a href="tours.html" class="text-dark"><h4 class="font-weight-semibold2">London Tour</h4></a>
				...
				<div class="item">
					<div class="card mb-0 overflow-hidden">
						...
						<div class="card-body">
							<div class="border-bottom pb-4 mb-4 d-inline-flex">
								<span class="border-end pe-3 me-3"><i class="icon icon-clock me-1"></i> 10 Days</span>
								<span class="border-end pe-3 me-3"><i class="icon icon-location-pin me-1"></i> India</span>
								<span class=""><i class="icon icon-event me-1"></i> 8th Oct</span>
							</div>
							<div class="item-card7-desc">
								<div class="item-card7-text d-flex">
									<a href="tours.html" class="text-dark"><h4 class="font-weight-semibold2">India Tour</h4></a>
									<div class="item-card2-rating mb-0 ms-auto">
									<div class=" d-inline-flex ms-auto">
										<div class="rating-star sm block my-rating-5" data-stars="4s">
										</div>
									</div>
				...
				<div class="item">
					<div class="card mb-0 overflow-hidden">
						...
						<div class="card-body">
							<div class="border-bottom pb-4 mb-4 d-inline-flex">
								<span class="border-end pe-3 me-3"><i class="icon icon-clock me-1"></i> 9 Days</span>
								<span class="border-end pe-3 me-3"><i class="icon icon-location-pin me-1"></i> Spain</span>
								<span class=""><i class="icon icon-event me-1"></i> 10th Oct</span>
							</div>
							<div class="item-card7-desc">
								<div class="item-card7-text d-flex">
									<a href="tours.html" class="text-dark"><h4 class="font-weight-semibold2">Spain Tour</h4></a>
									<div class="item-card2-rating mb-0 ms-auto">
									<div class=" d-inline-flex ms-auto">
										<div class="rating-star sm block my-rating-5" data-stars="4s">
										</div>
				...
				<div class="item">
					<div class="card mb-0 overflow-hidden">
						...
						<div class="card-body">
							<div class="border-bottom pb-4 mb-4 d-inline-flex">
								<span class="border-end pe-3 me-3"><i class="icon icon-clock me-1"></i> 12 Days</span>
								<span class="border-end pe-3 me-3"><i class="icon icon-location-pin me-1"></i> Australia</span>
								<span class=""><i class="icon icon-event me-1"></i> 9th Sep</span>
							</div>
							<div class="item-card7-desc">
								<div class="item-card7-text d-flex">
									<a href="tours.html" class="text-dark"><h4 class="font-weight-semibold2">Australia Tour</h4></a>
									<div class="item-card2-rating mb-0 ms-auto">
									<div class=" d-inline-flex ms-auto">
										<div class="rating-star sm block my-rating-5" data-stars="4s">
										</div>
				...
				<div class="item">
					<div class="card mb-0 overflow-hidden">
						...
						<div class="card-body">
							<div class="border-bottom pb-4 mb-4 d-inline-flex">
								<span class="border-end pe-3 me-3"><i class="icon icon-clock me-1"></i> 15 Days</span>
								<span class="border-end pe-3 me-3"><i class="icon icon-location-pin me-1"></i> London</span>
								<span class=""><i class="icon icon-event me-1"></i> 19th Oct</span>
							</div>
							<div class="item-card7-desc">
								<div class="item-card7-text d-flex">
									<a href="tours.html" class="text-dark"><h4 class="font-weight-semibold2">London Tour</h4></a>
				...
				<div class="item">
					<div class="card mb-0 overflow-hidden">
						...
						<div class="card-body">
							<div class="border-bottom pb-4 mb-4 d-inline-flex">
								<span class="border-end pe-3 me-3"><i class="icon icon-clock me-1"></i> 5 Days</span>
								<span class="border-end pe-3 me-3"><i class="icon icon-location-pin me-1"></i> Canada</span>
								<span class=""><i class="icon icon-event me-1"></i> 19th Nov</span>
							</div>
							<div class="item-card7-desc">
								<div class="item-card7-text d-flex">
									<a href="tours.html" class="text-dark"><h4 class="font-weight-semibold2">Canada Tour</h4></a>
									<div class="item-card2-rating mb-0 ms-auto">
									<div class=" d-inline-flex ms-auto">
										<div class="rating-star sm block my-rating-5" data-stars="4s">
										</div>
				...
				<div class="item">
					<div class="card mb-0 overflow-hidden">
						...
						<div class="card-body">
							<div class="border-bottom pb-4 mb-4 d-inline-flex">
								<span class="border-end pe-3 me-3"><i class="icon icon-clock me-1"></i> 16 Days</span>
								<span class="border-end pe-3 me-3"><i class="icon icon-location-pin me-1"></i> Paris</span>
								<span class=""><i class="icon icon-event me-1"></i> 18th Nov</span>
							</div>
							<div class="item-card7-desc">
								<div class="item-card7-text d-flex">
									<a href="tours.html" class="text-dark"><h4 class="font-weight-semibold2">Paris Tour</h4></a>
									<div class="item-card2-rating mb-0 ms-auto">
									<div class=" d-inline-flex ms-auto">
										<div class="rating-star sm block my-rating-5" data-stars="4s">
										</div>
	...
	<section class="sptb bg-white">
		<div class="container">
			<div class="section-title center-block text-center">
				<span class="heading-style text-secondary">Near By</span>
				<h2>Famous Hotels</h2>
				<p>Mauris ut cursus nunc. Morbi eleifend, ligula at consectetur vehicula</p>
			</div>
					...
					<div class="card mb-0 overflow-hidden">
						...
						<div class="item-card2-img">
							...
							<div class="item-card2-icons">
								<a href="tours.html" class="item-card2-icons-l"><i class="fa fa-cutlery"></i></a>
							...
							<div class="item-card2">
								<div class="item-card2-desc">
									<div class="item-card2-text">
										<a href="tours.html" class="text-dark"><h4 class="mb-0">Somik Hotel</h4></a>
									</div>
									<ul class="d-flex mt-3 mb-1">
										<li class=""><a href="javascript:void(0)" class="icons"><i class="fe fe-map-pin text-muted me-1 d-inline-block"></i> London</a></li>
										<li class=""><i class="fe fe-phone text-muted me-1 d-inline-block"></i> 141 675 6555</li>
									</ul>
									<p class="mt-4 mb-1">Lorem ipsum dolor sit amet, quis int nostrum exercitationem </p>
								</div>
							</div>
							<div class=" d-inline-flex ms-auto">
								<div class="rating-star sm block my-rating-5" data-stars="4s">
					...
					<div class="card mb-0 overflow-hidden">
						...
						<div class="card-body">
							<div class="item-card2">
								<div class="item-card2-desc">
									<div class="item-card2-text">
										<a href="tours.html" class="text-dark"><h4 class="mb-0">GilkonStar Hotel</h4></a>
									</div>
									<ul class="d-flex mt-3 mb-1">
										<li class=""><a href="javascript:void(0)" class="icons"><i class="fe fe-map-pin text-muted me-1 d-inline-block"></i> London</a></li>
										<li class=""><i class="fe fe-phone text-muted me-1 d-inline-block"></i> 141 675 6555</li>
					...
					<div class="card mb-0 overflow-hidden">
						...
						<div class="card-body">
							<div class="item-card2">
								<div class="item-card2-desc">
									<div class="item-card2-text">
										<a href="tours.html" class="text-dark"><h4 class="mb-0">Somic Hotel</h4></a>
									</div>
									<ul class="d-flex mt-3 mb-1">
										<li class=""><a href="javascript:void(0)" class="icons"><i class="fe fe-map-pin text-muted me-1 d-inline-block"></i> London</a></li>
										<li class=""><i class="fe fe-phone text-muted me-1 d-inline-block"></i> 141 675 6555</li>
	...
	<!--Section-->
	<section>
		<div class="cover-image sptb bg-background-color" data-image-src="/Assets/images/banners/banner10.jpg">
								...
								<div class="col-lg-7 mx-auto d-block">
									<div class="mt-5">
										<div class="input-group sub-input mt-1">
											...
											<div class="">
												<button type="button" class="btn btn-secondary btn-lg br-ts-0 br-bs-0  font-weight-semibold2">
													Subscribe
												</button>
											</div>
										</div>
			...
			<div class="row">
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="card overflow-hidden">
						...
						<div class="card-body">
							...
							<a class="btn-link" href="blog-details.html">Read More <i class="fa fa-angle-right"></i></a>
						</div>
					</div>
				</div>
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="card mb-md-0 overflow-hidden">
						<div class="item7-card-img">
							<a class="d-block video-btn1 mx-auto" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#homeVideo"><span class="fa fa-play text-white"></span></a>
							<img src="/Assets/images/thumbnails/thumb2.jpg" alt="img" class="cover-image">
						</div>
						<div class="card-body">
				...
				<div class="col-lg-4 col-md-4 col-sm-12">
					<div class="card mb-0 overflow-hidden">
						<div class="item7-card-img">
							<a class="d-block video-btn1 mx-auto" href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#homeVideo"><span class="fa fa-play text-white"></span></a>
							<img src="/Assets/images/thumbnails/thumb3.jpg" alt="img" class="cover-image">
						</div>
						<div class="card-body">
					...
					<div class="service-icon-timeline13">
						<div class="mb-sm-0 mb-4">
							<div class="service-card text-center">
								...
								<div class="servic-data mt-3">
									<h4 class="font-weight-semibold2 mb-2">Add Tour</h4>
									<p class="text-muted mb-0">Nam libero tempore, cum soluta nobis est eligendi cumque facere possimus</p>
								</div>
							</div>
						</div>
					...
					<div class="service-icon-timeline14">
						<div class="">
							<div class="service-card text-center">
								...
								<div class="servic-data mt-3">
									<h4 class="font-weight-semibold2 mb-2">Get Earnings</h4>
									<p class="text-muted mb-0">Nam libero tempore, cum soluta nobis est eligendi cumque facere possimus</p>
								</div>
							</div>
						</div>
	...
	<section class="sptb bg-white">
		<div class="container">
			<div class="section-title center-block text-center">
				<span class="heading-style text-secondary">Our</span>
				<h2 class=" position-relative">Customers Says</h2>
			</div>
			<div class="row">
				<div class="col-lg-12">
					<div class="">
						<div id="myCarousel12" class="owl-carousel owl-carousel-icons">
							<div class="item">
								<div class="card">
									<div class="card-status bg-primary br-te-7 br-ts-7"></div>
									<div class="carosel-shape-horizontal bg-primary-transparent"></div>
									<div class="card-body">
										<div class="team-section text-center">
											<div class="team-img">
												<img src="/Assets/images/faces/male/1.jpg" class="rounded-circle mx-auto text-center" alt="">
											</div>
											<h4 class="font-weight-bold dark-grey-text mt-4">Tracey	Poole</h4>
											<h6 class="text-muted">Recent Traveller</h6>
							...
							<div class="item">
								<div class="card">
									...
									<div class="carosel-shape-horizontal bg-secondary-transparent"></div>
									<div class="card-body">
										<div class="team-section text-center">
											<div class="team-img">
												<img src="/Assets/images/faces/female/1.jpg" class="rounded-circle mx-auto text-center" alt="">
											</div>
											<h4 class="font-weight-bold dark-grey-text mt-4">Harry	Walker</h4>
											<h6 class="text-muted">Travel Advisor</h6>
											<p class="font-weight-normal dark-grey-text">
											<i class="fa fa-quote-left pe-2"></i>Lorem ipsum dolor sit amet, quis nostrum exercitationem ullam quis nostrum  corporis suscipit laboriosam, nisi ut aliquid commodi.</p>
											<div class="text-warning">
												<i class="fa fa-star"> </i>
												<i class="fa fa-star"> </i>
												<i class="fa fa-star"> </i>
							...
							<div class="item">
								<div class="card">
									...
									<div class="carosel-shape-horizontal bg-success-transparent"></div>
									<div class="card-body">
										<div class="team-section text-center">
											<div class="team-img">
												<img src="/Assets/images/faces/male/2.jpg" class="rounded-circle mx-auto text-center" alt="">
											</div>
											<h4 class="font-weight-bold dark-grey-text mt-4">Paul White</h4>
											<h6 class="text-muted">Traveller</h6>
											<p class="font-weight-normal dark-grey-text">
											<i class="fa fa-quote-left pe-2"></i>At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum.</p>
											<div class="text-warning">
												<i class="fa fa-star"> </i>
												<i class="fa fa-star"> </i>
												<i class="fa fa-star"> </i>
							...
							<div class="item">
								<div class="card">
									...
									<div class="carosel-shape-horizontal bg-warning-transparent"></div>
									<div class="card-body">
										<div class="team-section text-center">
											<div class="team-img">
												<img src="/Assets/images/faces/female/5.jpg" class="rounded-circle mx-auto text-center" alt="">
											</div>
											<h4 class="font-weight-bold dark-grey-text mt-4">Harry	Walker</h4>
											<h6 class="text-muted">Travel Advisor</h6>
											<p class="font-weight-normal dark-grey-text">
							...
							<div class="item">
								<div class="card">
									...
									<div class="carosel-shape-horizontal bg-info-transparent"></div>
									<div class="card-body">
										<div class="team-section text-center">
											<div class="team-img">
												<img src="/Assets/images/faces/male/3.jpg" class="rounded-circle mx-auto text-center" alt="">
											</div>
											<h4 class="font-weight-bold dark-grey-text mt-4">Tracey	Poole</h4>
											<h6 class="text-muted">Recent Traveller</h6>
											<p class="font-weight-normal dark-grey-text">
			...
			<div id="defaultCarousel" class="owl-carousel Card-owlcarousel owl-carousel-icons">
					...
					<div class="card mb-0">
						...
						<div class="card-body">
							<div class="mb-3 mt-0 d-inline-flex">
								<a href="javascript:void(0)" class="me-0 ms-0 btn-link"><span class="text-default">By</span> Lilly Wisely</a>
								<a href="javascript:void(0)" class="ps-4 ms-4 border-start"> 4 comments</a>
							</div>
							<a href="blog-details.html" class="text-dark leading-normal"><h4 class="font-weight-semibold2 mt-2 leading-normal mb-0">Found Beautiful Places</h4></a>
							<div class=" d-inline-flex ms-auto">
								<div class="rating-star sm block my-rating-5" data-stars="4s">
								</div>
							</div>(75 Reviews)
				...
				<div class="item">
					<div class="card mb-0">
						...
						<div class="card-body">
							<div class="mb-3 mt-0 d-inline-flex">
								<a href="javascript:void(0)" class="me-0 ms-0 btn-link"><span class="text-default">By</span> Rosita Chatmon</a>
								<a href="javascript:void(0)" class="ps-4 ms-4 border-start"> 30 comments</a>
							</div>
							<a href="blog-details.html" class="text-dark leading-normal"><h4 class="font-weight-semibold2 mt-2 leading-normal mb-0">Great Adventure Trip</h4></a>
							<div class=" d-inline-flex ms-auto">
								<div class="rating-star sm block my-rating-5" data-stars="4s">
								</div>
							</div>(95 Reviews)
				...
				<div class="item">
					<div class="card mb-0">
						...
						<div class="card-body">
							<div class="mb-3 mt-0 d-inline-flex">
								<a href="javascript:void(0)" class="me-0 ms-0 btn-link"><span class="text-default">By</span> Loyd Nolf</a>
								<a href="javascript:void(0)" class="ps-4 ms-4 border-start"> 12 comments</a>
							</div>
							<a href="blog-details.html" class="text-dark leading-normal"><h4 class="font-weight-semibold2 mt-2 leading-normal mb-0">Special Places</h4></a>
							<div class=" d-inline-flex ms-auto">
								<div class="rating-star sm block my-rating-5" data-stars="4s">
								</div>
							</div>(76 Reviews)
				...
				<div class="item">
					<div class="card mb-0">
						<div class="item7-card-img">
							<a href="blog-details.html"></a>
							<img src="/Assets/images/thumbnails/thumb4.jpg" alt="img" class="cover-image">
						...
						<div class="card-body">
							<div class="mb-3 mt-0 d-inline-flex">
								<a href="javascript:void(0)" class="me-0 ms-0 btn-link"><span class="text-default">By</span> Aracely Bashore</a>
								<a href="javascript:void(0)" class="ps-4 ms-4 border-start"> 12 comments</a>
							</div>
				...
				<div class="item">
					<div class="card mb-0">
						<div class="item7-card-img">
							<a href="blog-details.html"></a>
							<img src="/Assets/images/thumbnails/thumb5.jpg" alt="img" class="cover-image">
						...
						<div class="card-body">
							<div class="mb-3 mt-0 d-inline-flex">
								<a href="javascript:void(0)" class="me-0 ms-0 btn-link"><span class="text-default">By</span> Royal Hamblin</a>
								<a href="javascript:void(0)" class="ps-4 ms-4 border-start"> 8 comments</a>
							</div>
							<a href="blog-details.html" class="text-dark leading-normal"><h4 class="font-weight-semibold2 mt-2 leading-normal mb-0">Its Best & Safe Tour</h4></a>
							<div class=" d-inline-flex ms-auto">
								<div class="rating-star sm block my-rating-5" data-stars="4s">
								</div>
							</div>(76 Reviews)
				...
				<div class="item">
					<div class="card mb-0">
						<div class="item7-card-img">
							<a href="blog-details.html"></a>
							<img src="/Assets/images/thumbnails/thumb6.jpg" alt="img" class="cover-image">
						...
						<div class="card-body">
							...
							<a href="blog-details.html" class="text-dark leading-normal"><h4 class="font-weight-semibold2 mt-2 leading-normal mb-0">Most Memorable Experiences</h4></a>
							<div class=" d-inline-flex ms-auto">
								<div class="rating-star sm block my-rating-5" data-stars="4s">
								</div>
							</div>(76 Reviews)
