...
JTB offices are located in Kingston, Montego Bay, Miami, Toronto and London. Representative offices are located in Berlin (Germany), Barcelona (Spain), Rome (Italy), Amsterdam (The Netherlands) and Tokyo (Japan).
						<a class="btn-link" href="javascript:void(0)">View More</a></p>
						...
						<div class="owl-carousel owl-carousel-icons52">
							...
							<div class="item">
								<div class="text-center br-5 overflow-hidden">
									...
									<h6 class="mb-0 p-3 border border-top-0 br-bs-5 br-be-5">Berlin</h6>
								</div>
							</div>
							<div class="item">
								<div class="text-center br-5 overflow-hidden">
		...
		<div class="container">
			<div class="section-title center-block text-center">
				...
				<p><br />Here at the Jamaica Tourist Board, we offer a variety of services that you can gain access to in just a few simple
					...
					you've succeeded in booking your cruise or flight, you can pay upfront.<br />It's just that easy working with us.
				</p>
			</div>
					...
					<div class="service-timeline">
						<div class="mb-sm-0 mb-4">
							<div class="service-card text-center">
								...
								<div class="servic-data mt-3">
									<h4 class="font-weight-semibold mb-0">Book Vacation</h4>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="service-timeline">
						<div class="">
							<div class="service-card text-center">
								...
								<div class="servic-data mt-3">
									<h4 class="font-weight-semibold mb-0">Make Payments</h4>
								</div>
							</div>
						</div>
					</div>
