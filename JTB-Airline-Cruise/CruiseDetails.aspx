							...
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										...
										<asp:TextBox ID="NameTextBox" runat="server" CssClass="form-control" placeholder="Name" TextMode="Url"></asp:TextBox>
								...
								<div class="col-sm-12 col-md-12">
									<div class="form-group">
										...
										<asp:TextBox ID="EmailTextBox" runat="server" CssClass="form-control" placeholder="Email Address" TextMode="Url"></asp:TextBox>
					...
					<div class="card">
						...
						<div class="card-body">
							<div class="form-group">
								...
								<asp:TextBox ID="CardNameTextBox" runat="server" CssClass="form-control" placeholder="Name On Card" TextMode="Url"></asp:TextBox>
							...
							<div class="form-group">
								...
								<asp:TextBox ID="CardNumberTextBox" runat="server" CssClass="form-control" placeholder="Card Number" TextMode="Url"></asp:TextBox>
							...
							<div class="row">
								<div class="col-sm-8">
									<div class="form-group mb-sm-0">
										...
										<div class="input-group">
											<asp:TextBox ID="ExpiryDateTextBox" runat="server" CssClass="form-control" placeholder="MM/YY" TextMode="Url"></asp:TextBox>
								...
								<div class="col-sm-4 ">
									<div class="form-group mb-0">
										...
										<asp:TextBox ID="CVVTextBox" runat="server" CssClass="form-control" placeholder="CVV" TextMode="Url"></asp:TextBox>
