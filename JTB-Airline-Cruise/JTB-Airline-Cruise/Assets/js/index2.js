...
function survey (myVarVal) {
	...
	var myChart = new Chart(myCanvas, {
		...
		data: {
			...
			datasets: [{
				...
				hooverBackgroundColor: gradientStroke2,
				hoverBorderWidth: 2,
	...
	new Morris.Donut({
		...
		colors: [`rgb(${myVarVal})`, '#f68284', '#05a01f','#0b7eb7'],
...
function lineChart1 (myVarVal) {
	var ctx = document.getElementById("lineChart1");
		...
		var myChart = new Chart(ctx, {
			...
			data: {
				...
				datasets: [{
					...
					borderWidth: "5",
					backgroundColor: `rgb(${myVarVal}, 0.6)`,
		...
		gradientStroke1.addColorStop(0, `rgba(${myVarVal}, 0)`);
