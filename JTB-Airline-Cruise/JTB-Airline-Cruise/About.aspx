<%@ Page Title="About" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="About.aspx.cs" Inherits="JTB_Airline_Cruise.About" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <!--Breadcrumb-->
			...
			<div class="header-text mb-0">
				<div class="container">
					<div class="row text-white">
						<div class="col"><h1 class="">About Us</h1></div>
			...
			<div class="content-text mb-0">
				<div class="container">
					<div class="row">
						...
						<div class="col-lg-4">
							<img src="/Assets/images/1.png" alt="" class="img-absolute-bottom w-100">
						</div>
						<div class="col-lg-8 sptb">
							<div class="section-title text-start pb-2">
								<h2>About Us</h2>
							</div>
							<p class="leading-normal-2">There are many variations of passages of Lorem Ipsum available, but the majority have suffered  by injected humour, or randomised words which don't look even slightly believable.
							If you are going to use a passage of Lorem Ipsum It is a long established fact that a reader will be distracted by the readable of a page when looking at its layout. as opposed to using 'Content here, content here', making it look like readable English. <a class="btn-link" href="javascript:void(0)">View More</a></p>

							<h4 class="font-weight-semibold2 mt-6 mb-4">Our Gallery</h4>
				...
				<div class="row service-time-line-main">
					...
					<div class="col-lg-3 col-md-6 col-sm-6">
						<div class="service-timeline">
							<div class="">
								<div class="service-card text-center">
									<div class="bg-success icon-bg  icon-service text-purple about service-card-svg">
										<!-- Earnings Svg-->
									...
									<div class="servic-data mt-3">
										<h4 class="font-weight-semibold mb-0">Get Earnings</h4>
									</div>
								</div>
							</div>
						</div>
		...
		<!--Section-->
		<section>
			<div class="cover-image pt-10 pb-10 bg-background2 bg-background-color-dark" data-image-src="/Assets/images/banners/banner11.jpg">
				<div class="content-text mb-0">
					<div class="container">
						<div class="row">
							<div class="col-md-7">
								<div class="text-white">
									<h2 class="mb-2 display-5 font-weight-semibold2 leading-normal">Are you ready for the posting your tours on this Site?</h2>
									<p class="fs-16 leading-loose">There are many variations of passages of Lorem Ipsum available, but the majority have suffered  by injected humour, or randomised words which don't look even slightly believable.</p>
									<div class="mt-6">
										<a href="add-post.html" class="btn btn-lg btn-secondary px-7">Free Post Ad</a>
									</div>
								</div>
							</div>
						</div>
		...
		<!--Section-->
		<section>
			<div class="about-1 cover-image sptb">
				<div class="content-text mb-0 info">
					<div class="container">
						<div class="row text-center">
							<div class="col-lg-3 col-md-6">
								<div class="counter-status status md-lg-0">
									<div class="counter-icon text-white bg-primary border-0 mb-2">
										<i class="icon icon-location-pin text-white"></i>
									</div>
									<h5 class="mb-4">Total Places</h5>
									<h2 class="counter mb-0 font-weight-semibold2">17,846</h2>
								</div>
							</div>
							<div class="col-lg-3 col-md-6">
								<div class="counter-status status-1 md-lg-0">
									<div class="counter-icon text-white bg-secondary border-0 mb-2">
										<i class="icon icon-directions text-white"></i>
									</div>
									<h5 class="mb-4">Famous Places</h5>
									<h2 class="counter mb-0 font-weight-semibold2">5,463</h2>
								</div>
							</div>
							<div class="col-lg-3 col-md-6">
								<div class="counter-status mb-md-0">
									<div class="counter-icon text-white bg-success border-0 mb-2">
										<i class="icon icon-people text-white"></i>
									</div>
									<h5 class="mb-4"> Our Clients</h5>
									<h2 class="counter mb-0 font-weight-semibold2">7,569</h2>
								</div>
							</div>
							<div class="col-lg-3 col-md-6">
								<div class="counter-status status mb-0">
									<div class="counter-icon text-white bg-info border-0 mb-2">
										<i class="icon icon-emotsmile text-white"></i>
									</div>
									<h5 class="mb-4">Happy Customers</h5>
									<h2 class="counter mb-0 font-weight-semibold2">7,253</h2>
								</div>
							</div>
						</div>
					</div>
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-4 col-xl-4 col-md-12">
						<div class="card mb-lg-0 overflow-hidden">
							<div class="item-card7-imgs">
								<img src="/Assets/images/faces/guide-04.jpg" alt="img" class="mx-auto">
							</div>
							<div class="card-body">
								<div class="item-card7-desc">
									<div class="item-card7-text d-flex">
										<a href="personal-profile.html" class="text-dark"><h5 class="font-weight-bold">Lilly Wisely</h5></a>
										<div class=" d-inline-flex ms-auto">
											<div class="rating-star sm block my-rating-5" data-stars="4s">
											</div>
										</div>
									</div>
									<div class="border-bottom pb-4 mb-4 border-dashed border-top-0 border-start-0 border-end-0">
										<a href="javascript:void(0)" class="pe-3 me-2 border-end"><span class=""><i class="fe fe-briefcase me-1"></i> CEO</span></a>
										<a href="javascript:void(0)" class="pe-3 me-2"><span class=""><i class="fe fe-map-pin me-1"></i> Canada</span></a>
									</div>
									<p class="">Omnis iste natus error sit dolore dg voluptatem accusantium</p>
									<div class="d-flex">
										<a class="p-2 text-primary fs-18" href=""><i class="fa fa-facebook"></i></a>
										<a class="p-2 text-secondary fs-18" href=""><i class="fa fa-twitter"></i></a>
										<a class="p-2 text-success fs-18" href=""><i class="fa fa-rss"></i></a>
										<a class="p-2 text-info fs-18" href=""><i class="fa fa-google-plus"></i></a>
									</div>
								</div>
							</div>
						</div>
					...
					<div class="col-lg-4 col-xl-4 col-md-12">
						<div class="card mb-lg-0 overflow-hidden">
							<div class="item-card7-imgs">
								<img src="/Assets/images/faces/guide-02.jpg" alt="img" class="mx-auto">
							</div>
							<div class="card-body">
								<div class="item-card7-desc">
									<div class="item-card7-text d-flex">
										<a href="personal-profile.html" class="text-dark"><h5 class="font-weight-bold">John Smith</h5></a>
										<div class=" d-inline-flex ms-auto">
											<div class="rating-star sm block my-rating-5" data-stars="4s">
											</div>
										</div>
									...
									<div class="border-bottom pb-4 mb-4 border-dashed border-top-0 border-start-0 border-end-0">
										<a href="javascript:void(0)" class="pe-3 me-2 border-end"><span class=""><i class="fe fe-briefcase me-1"></i> HR Manager</span></a>
										<a href="javascript:void(0)" class="pe-3 me-2"><span class=""><i class="fe fe-map-pin me-1"></i> Spain</span></a>
									</div>
									<p class="">Omnis iste natus error sit dolore dg voluptatem accusantium</p>
									<div class="d-flex">
										<a class="p-2 text-primary fs-18" href=""><i class="fa fa-facebook"></i></a>
					...
					<div class="col-lg-4 col-xl-4 col-md-12">
						<div class="card mb-0 overflow-hidden">
							<div class="item-card7-imgs">
								<img src="/Assets/images/faces/guide-03.jpg" alt="img" class="mx-auto">
							</div>
							<div class="card-body">
								<div class="item-card7-desc">
									<div class="item-card7-text d-flex">
										<a href="personal-profile.html" class="text-dark"><h5 class="font-weight-bold">Rebaca Mary</h5></a>
										<div class=" d-inline-flex ms-auto">
											<div class="rating-star sm block my-rating-5" data-stars="4s">
											</div>
										</div>
									...
									<div class="border-bottom pb-4 mb-4 border-dashed border-top-0 border-start-0 border-end-0">
										<a href="javascript:void(0)" class="pe-3 me-2 border-end"><span class=""><i class="fe fe-briefcase me-1"></i> Director</span></a>
										<a href="javascript:void(0)" class="pe-3 me-2"><span class=""><i class="fe fe-map-pin me-1"></i> France</span></a>
									</div>
									<p class="">Omnis iste natus error sit dolore dg voluptatem accusantium</p>
									<div class="d-flex">
										<a class="p-2 text-primary fs-18" href=""><i class="fa fa-facebook"></i></a>
