<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="Cruiselines.aspx.cs" Inherits="JTB_Airline_Cruise.Admin.Cruiseliner" %>
        ...
        <div class="side-app">
            <div class="page-header">
				...
				<ol class="breadcrumb">
					...
					<li class="breadcrumb-item active" aria-current="page">All Cruiselines</li>
				</ol>
			</div>
				...
				<div class="col-md-12 col-lg-12">
					<div class="card">
						<div class="card-header">
							<h3 class="card-title">All Cruiselines</h3>
						</div>
						<div class="card-body">
